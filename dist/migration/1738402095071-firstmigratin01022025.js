...
exports.Firstmigratin010220251738402095071 = void 0;
class Firstmigratin010220251738402095071 {
    constructor() {
        this.name = 'Firstmigratin010220251738402095071';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TYPE "public"."attendance_status_enum" AS ENUM('present', 'excused', 'unexcused', 'late', 'no status')`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TYPE "public"."attendance_status_enum"`);
...
exports.Firstmigratin010220251738402095071 = Firstmigratin010220251738402095071;
