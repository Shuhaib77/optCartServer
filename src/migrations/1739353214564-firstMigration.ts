...
export class FirstMigration1739353214564 implements MigrationInterface {
    name = 'FirstMigration1739353214564'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "attendance" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."attendance_status_enum" NOT NULL DEFAULT 'no status', "date" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "complaints" ADD CONSTRAINT "FK_233aef88f582679727a00e5ec64" FOREIGN KEY ("branchesId") REFERENCES "branches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "complaints" DROP CONSTRAINT "FK_233aef88f582679727a00e5ec64"`);
