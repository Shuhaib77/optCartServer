...
export class Firstmigratin010220251738399061005 implements MigrationInterface {
    name = 'Firstmigratin010220251738399061005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."attendance_status_enum" AS ENUM('present', 'excused', 'unexcused', 'late', 'no status')`);
